...
try:
    connection = psycopg2.connect(
        dbname=os.getenv("POSTGRES_DB", "address_service_db"),
...
echo "Starting address-service with hot reload and debug logs..."
...
uvicorn app.main:app --host 0.0.0.0 --port 8007 --reload --log-level debug
